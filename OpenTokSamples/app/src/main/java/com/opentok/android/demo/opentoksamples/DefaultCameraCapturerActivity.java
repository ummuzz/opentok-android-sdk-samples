...
public class DefaultCameraCapturerActivity extends Activity implements
    ...
    public void onPause() {
        ...
        Intent notificationIntent = new Intent(this, DefaultCameraCapturerActivity.class);
        ...
        if (mConnection == null) {
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName className, IBinder binder) {
                    ((ClearNotificationService.ClearBinder) binder).service.startService(new Intent(DefaultCameraCapturerActivity.this, ClearNotificationService.class));
        ...
        if (!mIsBound) {
            bindService(new Intent(DefaultCameraCapturerActivity.this,
    ...
    private void sessionConnect() {
        if (mSession == null) {
            mSession = new Session(DefaultCameraCapturerActivity.this,
    ...
    private void subscribeToStream(Stream stream) {
        mSubscriber = new Subscriber(DefaultCameraCapturerActivity.this, stream);
